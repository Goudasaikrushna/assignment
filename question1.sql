...
CREATE TABLE `PIRATES` (
  `PIRATE_NAME` varchar(50) DEFAULT NULL,
  `PIRATE_LAST_NAME` varchar(50) DEFAULT NULL,
  `WEAPON_OF_CHOICE` varchar(50) NOT NULL
...
INSERT INTO `PIRATES` VALUES ('JACK','SPARROW','THE SWORD');
...
-- Dump completed on 2022-11-16 18:59:39
